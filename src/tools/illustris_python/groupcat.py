...
def gcPath(basePath, snapNum, chunkNum=0):
    ...
    gcPath = f'{basePath}/groups_{snapNum.zfill(3)}/' 
    filePath1 = f'{gcPath}groups_{snapNum.zfill(3)}.{chunkNum}.hdf5'
    filePath2 = f'{gcPath}fof_subhalo_tab_{snapNum.zfill(3)}.{chunkNum}.hdf5' 
...
def offsetPath(basePath, snapNum):
    ...
    offsetPath =  f'{basePath}/../postprocessing/offsets/offsets_{snapNum.zfill(3)}.hdf5' 
...
def loadObjects(basePath, snapNum, gName, nName, fields):
    ...
    with h5py.File(gcPath(basePath, snapNum), 'r') as f:
        ...
        if not result['count']:
            print(f'warning: zero groups, empty return (snap={snapNum}).')
            return result
